...
% vals = [2.69 2.84 2.85 2.84; 2.41 1.85 1.40 0.64; 1.50 1.05 0.79 -0.08; 1.55 1.00 0.40 -0.30;
...
%     2.24 2.35 2.41 2.53; 1.83 1.79 1.78 1.89; 1.56 2.00 2.02 1.09; 2.23 1.70 1.03 -0.18;
...
%     ylim([-1 3])
% %     if ind == 1
% %         legend('Dur=1d','Dur=3d','Dur=7d','Dur=30d')
% %     end
% end
% leg = legend('Dur=1d','Dur=3d','Dur=7d','Dur=30d','Orientation', 'Horizontal');
% leg.Layout.Tile = 'south';

    X = categorical({'1d','3d','7d','30d'});
    X = reordercats(X,{'1d','3d','7d','30d'});
val = [2.5 1500; 3.6 4500;   ]